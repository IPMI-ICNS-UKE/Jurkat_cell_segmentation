...
""" Trains a small reservoir computing model on streams of
    Ca Imaging data to segment single objects. """
...
# set paths
root_dir = '.~/Task1/RC/Data/Green'  # green emission
# root_dir = '.~/Task1/RC/Data/Red'  # red emission
...
target_dirs = ['GT_01/', 'GT_02/', 'GT_03/', 'GT_04/', 'GT_05/']
